...
export function activate(context: vscode.ExtensionContext) {
	 ...
	 */
    let createFeatureDisposable = vscode.commands.registerCommand('extension.createFeatureDirectory', async (uri: vscode.Uri) => {
	 ...
	 * @param uri - The URI of the selected directory.
	 */
    let addSubFeatureDisposable = vscode.commands.registerCommand('extension.addSubFeatureDirectory', async (uri: vscode.Uri) => {
 ...
 */
async function getBaseDirectory(uri: vscode.Uri): Promise<string | undefined> {
 ...
 */
function findFeatureDirectory(startDir: string): string | null {
 ...
 */
function isFeatureDirectory(dirPath: string): boolean {
 ...
 */
async function promptForFeatureName(): Promise<string | undefined> {
 ...
 */
async function promptForSubFeatureNames(): Promise<string[]> {
 ...
 */
async function promptForStateManagement(): Promise<string | undefined> {
 ...
 */
function createFeatureDirectory(
    baseDir: string,
    featureName: string,
 ...
 */
function createDataLayer(featureDir: string, featureName: string) {
 ...
 */
function createDomainLayer(featureDir: string, featureName: string) {
 ...
 */
function createFeatureSubDirectory(dir: string, stateManagement: string) {
    createDir(dir);
 ...
 * ```
 */
function createStateManagementDirectories(dir: string, stateManagement: string, isEmpty: boolean = false) {
